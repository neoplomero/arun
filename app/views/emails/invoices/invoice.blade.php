                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 0px; padding-left: 0px; padding-top: 0; padding-bottom: 0;">
                                        ...
                                        <img align="left" alt="" src="https://gallery.mailchimp.com/d05f6bed2a14293cfd5f65244/images/f83287c6-ffbb-42db-8905-7d5e0c01e848.png" width="600" style="max-width:1200px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
                ...
                <table align="left" border="0" cellpadding="0" cellspacing="0" width="600" class="mcnTextContentContainer">
                    <tbody><tr>
                        ...
                        <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                            ...
                            <h1>Hello {{ $data->customer->full_name }}!</h1>

<h3>We hope you are very Well! We want to let you know that you can access to your Invoice with date: {{ Format::date($data->delivery_date) }} folowing the next link:</h3>

<h3 style="text-align: center;"><br>
<br>
<span style="color:#006400"><span style="font-size:13px; line-height:1.6em">&nbsp;</span></span><a class="mc-template-link" href="{{ route('view/invoice', [ $data->id ])}}" style="font-size: 13px; line-height: 1.6em;"><span style="color:#006400">---  Invoice  --</span></a></h3>
<br>
                    ...
                    <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer">
                        <tbody><tr>
                            <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0;">
                                        ...
                                        <img align="left" alt="" src="https://gallery.mailchimp.com/d05f6bed2a14293cfd5f65244/images/eb8efeee-db5b-47e0-a3c4-7774f8ea60b4.jpg" width="564" style="max-width:718px; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
...
Dublin 7<br>
<br>
Email: bakeryarunfinance@gmail.com<br>
Tel: 08794250535<br>
Tax Registration No: IE2518458F
                        </td>
                    </tr>
                </tbody></table>
